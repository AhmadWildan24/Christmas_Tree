        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            else if (_Mode == 1.0)
            {
                ...
                if (time - _LastColorChangeTime >= _ColorChangeInterval)
                {
                    ...
                    // Mengatur warna berdasarkan indeks
                    if (colorIndex == 1)      c.rgb = float3(1.0, 0.0, 0.0); // Merah
                    else if (colorIndex == 0) c.rgb = float3(1.0, 1.0, 0.0); // Kuning
                    else if (colorIndex == 6) c.rgb = float3(0.0, 1.0, 0.0); // Hijau
                    else if (colorIndex == 5) c.rgb = float3(0.0, 0.0, 1.0); // Biru
                    else if (colorIndex == 4) c.rgb = float3(1.0, 0.0, 1.0); // Ungu
                    else if (colorIndex == 3) c.rgb = float3(0.0, 1.0, 1.0); // Cyan
